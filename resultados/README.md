...
Las capturas PNG se obtienen manualmente a partir del dashboard y del README renderizado en GitHub. Si cambia el análisis o la documentación representada, corresponde actualizar las capturas para mantener la coherencia con el informe académico.
