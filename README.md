...
Describir y comparar el desempeño observado de las plantas de tratamiento, identificar patrones y situaciones que requieran revisión, evaluar las limitaciones de calidad de los datos y presentar resultados útiles para la toma de decisiones.

El alcance es descriptivo, exploratorio y comparativo. No se realizan predicciones ni se establecen relaciones causales, porque el dataset no contiene antecedentes suficientes sobre capacidades de diseño, metas operacionales, condiciones del proceso o criterios normativos aplicables.
...
- `codigo/funciones_analisis.py`: funciones reutilizables para preparar los datos, construir reportes y persistir resultados.
...
El archivo HTML incorpora Plotly y mantiene su interactividad sin conexión a internet.
...
- Algunos valores iguales de DBO de salida aparecen asociados tanto a cumplimiento como a incumplimiento.
...
El análisis principal, el dashboard, las funciones reutilizables y los reportes diferenciados se encuentran implementados y verificados. La documentación académica y la revisión final de la entrega continúan en desarrollo.